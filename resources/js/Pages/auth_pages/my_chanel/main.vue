...
<template>
    <ChanelLayout>
        <div class="video-section bg-white p-2 mt-3" v-if="$page.props.auth.chanel[0]">
        ...
        <div v-else class="dont_have_chanel">
                <p class="text-center">قم بإنشاء قنات لتتمكن من رفع الفيديوهات عليها</p>
                <button class="button_add mr-0" @click="add_chanel_function">
                    إنشاء قنات
                    <i class="fa-solid fa-plus"></i>
                </button>
        </div>
            <!-- popup create chanel -->
                <div class="chanel_frame" id="loginModal" v-if="add_chanel">
                    <div class="panel_chanel">
                        <div class="modal-header">
                            <h5 class="modal-title " style="color: #b2dfdb;" id="exampleModalLabel">
                                إنشاء قنات
                            </h5>
                            <button type="button" class="close" @click="add_chanel_function" >
                                <span>&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                                <form @submit.prevent="add_chanel_db">
                                        <div class="small_panel">
                                            <div class="form-group">
                                                <label for="name" class="col-form-label text-white">إسم القنات</label>
                                                <input type="text" class="form-control" id="name" v-model="add_chanel_values.name" required :error="add_chanel_values.errors.name">
                                            </div>
                                            <div class="form-group">
                                                <label for="dis" class="col-form-label text-white">وصف للقنات</label>
                                                <textarea name="discription" class="form-control form-control-text" id="dis" v-model="add_chanel_values.discription" required :error="add_chanel_values.errors.discription"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="dis" class="col-form-label text-white">خلفية القنات </label>
                                                <div class="img_body">
                                                    <div class="image_panel1">
                                                        <img src="img/chanels/base_back.webp" alt="">
                                                    </div>
                                                    <file-input
                                                        v-model="add_chanel_values.img_path"
                                                        :error="add_chanel_values.errors.img_path"
                                                        class="file_shoser"
                                                        type="file"
                                                        accept="image/*"
                                                    />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="img_body">
                                                    <div class="image_panel2">
                                                        <img src="img/chanels/base_logo.png" alt="">
                                                    </div>
                                                    <file-input
                                                        v-model="add_chanel_values.logo_path"
                                                        :error="add_chanel_values.errors.logo_path"
                                                        class="file_shoser"
                                                        type="file"
                                                        accept="image/*"
                                                    />
...
export default {
    ...
    methods: {
        ...
        add_main_videos_db(){
            if(this.fileSizeError){
            this.add_main_videos_values.post(`my_videos_AUTH/${this.$page.props.auth.chanel[0].id}/upload_main`, {
                onProgress: () => {
