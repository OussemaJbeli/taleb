                    ...
                    <div class="col-lg-5 show_details_respanse">
                        <div class="card-block mb-4">
                            <div class="flex direction-row items-center">
                                <a class="channel-img">
                                    <Link :href="`/chanel_gest/${table_target_video_count.video_chanels_id}}`" class="card-text flex items-center">
                            ...
                            <p class="card-text overflow-hidden max-h-60">{{table_target_video_count.discription}}</p>
                        </div>
                        <small class="text-muted mr-4 mb-2">
                        ...
                        <div class="mb-4 flex direction-row justify-between ">
                            <div class="w-100 flex flex-row items-center">
                                ...
                                <button class="float-right btn text-white btn-warning mt-4 mr-2">
                                    <i class="fa-solid fa-triangle-exclamation"></i>
                                    إبلاغ
                                </button>
                            </div>
                    ...
                    <div class="comments">
                        ...
                        <div class="public-comments">
                            <div class="form-group2">
                                <!-- form coment -->
                                <div >
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="إضافة تعليق"></textarea>
                                    <button @click="needt_login_function" class="btn btn-warning mt-3">تعليق</button>
                                </div>
                                <!-- coments -->
                                <div class="card mt-5 mb-3 coment_frame">
                                    <div class="card-body">
                                        ...
                                        <div class="row_comment" v-for="(coment,index) in table_comment_count">
                                            <div class="image_user_logo flex items-center">
                                                ...
                                                <p class="text-secondary text-center reply-time">منذ {{ coment.date_count }} </p>
                                            </div>
                                            <div class="dis_comment_part">
                                                <p>
                                                    <Link class="float-right mt-3 mt-md-4" :href="`/chanel_gest/${coment.coments_chanels_id}`" v-if="coment.coments_chanels_name"><strong>{{ coment.coments_chanels_name }}</strong></Link>
                                                    <p  @click="dont_have_chanel_function(coment.coments_user_name)" class="cursor-pointer float-right mt-3 mt-md-4" v-else><strong>{{ coment.coments_user_name }}</strong></p>
                                                </p>
                                                            ...
                                                            <div class="accordion-item">
                                                                ...
                                                                <div v-for="(Subcoment,index1) in  table_Subcomment_count" :id="`flush-collapse${coment.id}` " class="accordion-collapse collapse visible" :aria-labelledby="`flush-headingOne${coment.id}`" :data-bs-parent="`#accordionFlushExample${coment.id}`">
                                                                    <div  v-if="parseInt(Subcoment.id_coment, 10) == coment.id" class="accordion-body">
                                                                        <div class="row_comment row_comment1">
                                                                            <div class="image_user_logo items-center">
                                                                            ...
                                                                            <div class="dis_comment_part">
                                                                                <p>
                                                                                    <Link :href="`/chanel_gest/${Subcoment.coments_chanels_id}`" v-if="Subcoment.coments_chanels_name"><strong>{{ Subcoment.coments_chanels_name }}</strong></Link>
                                                                                    <p class= "cursor-pointer" v-else  @click="dont_have_chanel_function(Subcoment.coments_user_name)"><strong>{{ Subcoment.coments_user_name }}</strong></p>
                                                                                </p>
                            ...
                            <div class="card_dis">
                                <div class="card-block h-100">
                                    ...
                                    <small class="text-muted ">
                                        <span><i class="fa-solid fa-eye"></i>{{video.vuews_video}} مشاهدة</span> 
                                        <Link class="channel-img" :href="`/chanel_gest/${video.id_chanel}}`">
