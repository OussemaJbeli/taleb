...
class chanel_gest_Controller extends Controller
{
    /**
    ...
    {   
        ...
        return Inertia::render('gest_pages/my_chanel_gest/main',[
            'videos' => $videos,
    ...
    public function other_videos_AUTH($id_chanel_var)
    {
        ...
        return Inertia::render('gest_pages/my_chanel_gest/my_videos',[
            'videos' => $videos,
            'chanel' => chanels::where('chanels.id', $id_chanel_var)
                ->leftJoin('subscribes', 'subscribes.id_chanel', '=', 'chanels.id') 
                ->select(
    ...
    public function other_playlist_AUTH($id_chanel_var)
    {
        ...
        return Inertia::render('gest_pages/my_chanel_gest/play_list',[
    ...
    public function other_about_AUTH($id_chanel)
    {
        ...
        return Inertia::render('gest_pages/my_chanel_gest/about',[
    ...
    public function other_subscribs_AUTH($id_chanel,$id_user)
    {
        ...
        return Inertia::render('gest_pages/my_chanel_gest/sub_chanels',[
